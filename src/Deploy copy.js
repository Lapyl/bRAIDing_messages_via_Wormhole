...
async function main() {
	...
	htmlout = htmlout + "<h3>Sender</h3>" + chain0Id + " | " + chain0Name + "<br />" + senderContract.target;
	htmlout = htmlout + "<h3>Receiver 1</h3>" + chain1Id + " | " + chain1Name + "<br />" + receiver1Contract.target;
	htmlout = htmlout + "<h3>Receiver 2</h3>" + chain2Id + " | " + chain2Name + "<br />" + receiver2Contract.target;
